/* Class BinSearchTree */
 class BinSearchTree
 {
	 ...
	 private int findMax(BinTreeNode n)
	 {
	 ...
	 private int findMin(BinTreeNode n)
	 {
		 if(n.leftChild == null)
			return n.getVal();
		 else
	 ...
	 private void decending(BinTreeNode r)
	 {	
		 if (r != null)
         {         
             decending(r.getRightChild());
             System.out.print(r.getVal() +" ");
			 decending(r.getLeftChild());    
         }
	 }
